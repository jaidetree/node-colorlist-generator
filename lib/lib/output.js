(function() {
  ...
  Output = (function() {
    ...
    Output.prototype.save = function(result) {
      var filename;
      filename = path.join(path.dirname(path.dirname(__dirname)), 'output/' + this.file);
  ...
  HTMLOutput = (function(_super) {
    ...
    HTMLOutput.prototype.render = function() {
      var result;
      result = _f(this.html, this.colors.length, this.renderColors());
  ...
  JSONOutput = (function(_super) {
    ...
    JSONOutput.prototype.render = function() {
      ...
      return this.save(JSON.stringify(colors));
    };
